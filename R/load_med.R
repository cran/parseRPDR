...
load_med <- function(file, merge_id = "EMPI", sep = ":", id_length = "standard", perc = 0.6, na = TRUE, identical = TRUE, nThread = 4, mrn_type = FALSE) {
  ...
  DATA$med_clinic      <- pretty_text(data_raw$Clinic, remove_after = FALSE, remove_white = FALSE)
