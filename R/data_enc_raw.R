#' @name data_enc_raw
#'
#' @title Example of enc.txt output from RPDR.
#'
#' @description A enc.txt output from RPDR loaded into a data table in R using \emph{data.table::fread()}.
#'
...
#' @format data.table
#'
#' @return data table, imported from enc.txt
#' \describe{
