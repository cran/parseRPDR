#' @name data_med
#'
#' @title Example of processed med.txt output from RPDR using the load_med() function.
#'
#' @description Result of a med.txt output from RPDR loaded into a data table in R using \emph{load_med()}.
#'
